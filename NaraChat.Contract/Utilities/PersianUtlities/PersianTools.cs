...
namespace NaraChat.Contract.Utilities.PersianUtlities
{
    public static class PersianTools
    {
      ...
      {"فروردین", "اردیبهشت", "خرداد", "تیر", "مرداد", "شهریور", "مهر", "آبان", "آذر", "دی", "بهمن", "اسفند"};
        ...
        public static string ConvertPersianDate(this string persianDate)
        {

            string[] parts = persianDate.Split('/');
            if (parts.Length != 3) return "فرمت تاریخ نادرست است";
            ...
            if (month < 1 || month > 12) return "ماه نامعتبر است";
